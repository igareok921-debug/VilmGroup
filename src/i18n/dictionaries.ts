...
export const dictionaries = {
  ro: {
    ...
    testimonials: {
      ...
      play: "Redă",
      close: "Închide",
      googleReviews: "Recenzii publicate pe Google",
      basedOn: "din",
      reviewsLabel: "recenzii",
      viewOnGoogle: "Vezi profilul pe Google",
      ratingOnly: "Evaluare publicată fără comentariu.",
  ...
  en: {
    ...
    testimonials: {
      ...
      play: "Play",
      close: "Close",
      googleReviews: "Reviews published on Google",
      basedOn: "from",
      reviewsLabel: "reviews",
      viewOnGoogle: "View profile on Google",
      ratingOnly: "Rating published without a comment.",
  ...
  ru: {
    ...
    testimonials: {
      ...
      play: "Смотреть",
      close: "Закрыть",
      googleReviews: "Отзывы, опубликованные в Google",
      basedOn: "на основе",
      reviewsLabel: "отзывов",
      viewOnGoogle: "Открыть профиль в Google",
      ratingOnly: "Оценка опубликована без комментария.",
